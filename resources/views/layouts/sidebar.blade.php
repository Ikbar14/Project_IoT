...
<head>
  ...
  <title>Green House Dashboard</title>
  <style>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="nav-link active" href="http://127.0.0.1:8000/dashboard">
      ...
      <span class="ms-1 font-weight-bold">Green House Dashboard</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link me-2" href="http://127.0.0.1:8000/device" id="nav-device">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link me-2" href="http://127.0.0.1:8000/log" id="nav-log">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <!-- Program 2: Sign Up -->
      <li class="nav-item">
        <a class="nav-link me-2" href="http://127.0.0.1:8000/rule" id="nav-rule">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="21" viewBox="0 0 640 512">
      ...
      <li class="nav-item">
        <a class="nav-link me-2" href="http://127.0.0.1:8000/monitoring" id="nav-monitoring">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
